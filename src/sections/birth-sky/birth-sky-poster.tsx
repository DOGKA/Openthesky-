...
import { constellationName, zodiacName } from "@/lib/sky/sky-insights";
import type { BirthProfile, City } from "@/lib/profiles";
...
export type PosterFonts = {
  eyebrow: SkFont; // 28 medium
  title: SkFont; // 56 medium
  body: SkFont; // 34 regular
  small: SkFont; // 28 regular
  big: SkFont; // 76 medium
  compass: SkFont; // 30 regular
};
...
/**
 * 1080×1920 story template: pure Skia, so it renders identically on-screen
 * (scaled preview) and offscreen via drawAsImage.
 */
