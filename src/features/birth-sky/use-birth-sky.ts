...
import { birthObserver, cityById, type BirthProfile, type Observer } from "@/profiles";
import { useSkyFrame, type FrameBody, type FrameConstellation, type FrameStar, type SkyFrame } from "@/sky/use-sky-frame";
import {
  ageInYears,
  bodiesAbove,
  isNight,
